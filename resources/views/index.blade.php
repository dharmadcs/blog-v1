...
<section class="cta-section theme-bg-light py-4">
    <div class="container text-center">
        <h2 class="heading">Welcome to DCS-Blog</h2>
        ...
        <div class="item mb-5">
            <div class="media">
                ...
                <div class="media-body">
                    ...
                    <div class="meta mb-1"><span class="date">Published {{ $post->created_at->toFormattedDateString() }}</span><span class="category">
                        <a href="/category?id={{ $post->category->id }}">{{ $post->category->name }}</a></span></div>
